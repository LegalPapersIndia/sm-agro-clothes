...
// PLACEHOLDER — replace with real clothes hero image once client provides one
import clothesHeroImg from "../../assets/clothes-hero.jpg";

const ClothesHero = () => {
  return (
    <section
      className="relative h-[50vh] md:h-[60vh] flex items-center justify-center bg-cover bg-center"
      style={{ backgroundImage: `url(${clothesHeroImg})` }}
    >
      ...
      >
        ...
        <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl font-semibold text-[#F1EBE1] leading-snug">
          Crafted with{" "}
          <span className="text-[#B8935A]">Precision</span>
        </h1>
      </motion.div>
    </section>
  );
