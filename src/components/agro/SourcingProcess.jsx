...
import { Sprout, ClipboardCheck, PackageCheck, Truck } from "lucide-react";
...
const steps = [
  {
    ...
    icon: <Sprout size={22} />,
    title: "Sourcing",
    desc: "Produce sourced directly from trusted growers and suppliers.",
  },
  {
    step: "02",
    icon: <ClipboardCheck size={22} />,
    title: "Quality Check",
    desc: "Each batch inspected for freshness, grade, and consistency.",
  },
  {
    step: "03",
    icon: <PackageCheck size={22} />,
    title: "Packing",
    desc: "Packed according to order requirements and transit conditions.",
  },
  {
    step: "04",
    icon: <Truck size={22} />,
    title: "Delivery",
    desc: "Dispatched on schedule and tracked until it reaches you.",
  },
];
